                ...
                <div class="card-body register-box">
                    <form method="POST" action="/payment-success" id="paymentForm">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input  name="first-name" id="first-name" type="text" class="form-control @error('first-name') is-invalid @enderror" value="{{ $user->first_name }}" required autocomplete="first-name" autofocus disabled>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input name="last-name" id="last-name" type="text" class="form-control @error('last-name') is-invalid @enderror" name="last-name" value="{{ $user->last_name }}" required autocomplete="last-name" autofocus disabled>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="email-address" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $user->email }}" required autocomplete="email" disabled>
      ...
      callback: function (response) {
        ...
        $.ajax({
          ...
          success: function (response) {
            ...
            if (data.status == true) {
              $.ajax({
                url: "{{URL::to('/another-payment-success')}}",
                method: 'POST',
                data: {
